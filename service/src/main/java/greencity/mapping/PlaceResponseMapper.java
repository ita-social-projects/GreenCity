    ...
    protected PlaceResponse convert(Place source) {
        return PlaceResponse.builder()
            .category(CategoryDto.builder()
                .nameEn(source.getCategory().getNameEn())
                .nameUk(source.getCategory().getNameUk())
                .build())
            ...
            .locationAddressAndGeoDto(AddPlaceLocation.builder()
                .addressUk(source.getLocation().getAddressUk())
                .addressEn(source.getLocation().getAddressEn())
