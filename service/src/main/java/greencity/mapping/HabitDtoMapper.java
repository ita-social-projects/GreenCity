    ...
    protected HabitDto convert(HabitTranslation habitTranslation) {
        ...
        return HabitDto.builder()
            ...
            .habitTranslation(HabitTranslationDto.builder()
                .descriptionEn("en".equals(language.getCode()) ? habitTranslation.getDescription() : null)
                .habitItemEn("en".equals(language.getCode()) ? habitTranslation.getHabitItem() : null)
                .nameEn("en".equals(language.getCode()) ? habitTranslation.getName() : null)
                .descriptionUk("ua".equals(language.getCode()) ? habitTranslation.getDescription() : null)
                .habitItemUk("ua".equals(language.getCode()) ? habitTranslation.getHabitItem() : null)
                .nameUk("ua".equals(language.getCode()) ? habitTranslation.getName() : null)
