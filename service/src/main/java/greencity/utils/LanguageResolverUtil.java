...
/**
 * Utility class for resolving language preferences based on the
 * `Accept-Language` HTTP header. This class provides a static method to parse
 * the language code and map it to a supported language.
 *
 * <p>
 * Supported languages are defined in the {@link greencity.enums.Language} enum.
...
public class LanguageResolverUtil {
     ...
     *
     * @param acceptLanguage the `Accept-Language` header value from the HTTP
     *                       request.
     * @return the display name of the resolved language, as defined in
     *         {@link greencity.enums.Language}. Defaults to English if the language
     *         code is not recognized or the header is null/blank.
     */
