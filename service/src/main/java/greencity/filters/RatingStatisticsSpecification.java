...
public class RatingStatisticsSpecification implements MySpecification<RatingStatistics> {
    ...
    public Predicate toPredicate(Root<RatingStatistics> root, CriteriaQuery<?> criteriaQuery,
        ...
        for (SearchCriteria searchCriteria : searchCriteriaList) {
            ...
            /*
             * if (searchCriteria.getType().equals("userMail")) { allPredicates =
             * criteriaBuilder.and(allPredicates, getUserMailPredicate(root,
             * criteriaBuilder, searchCriteria)); }
             */
    ...
    /*
     * private Predicate getUserMailPredicate(Root<RatingStatistics> root,
     ...
     * return criteriaBuilder.like(userJoin.get(User_.email), "%" +
