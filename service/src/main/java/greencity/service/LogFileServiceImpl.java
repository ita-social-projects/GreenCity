...
public class LogFileServiceImpl implements LogFileService {
     ...
     */
    @Override
    public PageableDto<LogFileMetadataDto> getLogFilesList(Pageable pageable, LogFileFilterDto filterDto, String secretKey) {
    ...
    public String getLogFileContent(String filename, String secretKey) {
        ...
        try {
            ...
            throw new FileReadException("Error reading log file: " + filename, e);
        }
    }
