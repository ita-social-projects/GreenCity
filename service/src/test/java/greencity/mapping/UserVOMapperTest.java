...
class UserVOMapperTest {
    ...
    void convert() {
        ...
        /*
         * User userToBeConverted = User.builder() .id(expected.getId())
         * .name(expected.getName()) .email(expected.getEmail())
         * //.role(expected.getRole()) //.userCredo(expected.getUserCredo())
         * //.firstName(expected.getFirstName())
         * //.emailNotification(expected.getEmailNotification())
         * .userStatus(expected.getUserStatus()) //.rating(expected.getRating())
         *//*
            * .verifyEmail(expected.getVerifyEmail() != null ? VerifyEmail.builder()
            * .id(expected.getVerifyEmail().getId()) .user(User.builder()
            * .id(expected.getVerifyEmail().getUser().getId())
            * .name(expected.getVerifyEmail().getUser().getName()) .build())
            * .token(expected.getVerifyEmail().getToken()) .build() : null)
            *//*
              *//*
                  * .userFriends(expected.getUserFriends() != null ? expected.getUserFriends()
                  * .stream().map(user1 -> User.builder() .id(user1.getId())
                  * .name(user1.getName()) .build()) .collect(Collectors.toList()) : null)
                  *//*
                     ...
                     *//*
                        ...
                        * .longitude(expected.getUserLocationDto().getLongitude()) .users(null)
                        * .build())
                        *//*
                           * //.showToDoList(expected.getShowToDoList())
                           * //.showEcoPlace(expected.getShowEcoPlace())
                           * .showLocation(expected.getShowLocation())
                           * .socialNetworks(expected.getSocialNetworks() != null ?
                           * expected.getSocialNetworks() .stream().map(socialNetwork ->
                           * SocialNetwork.builder() .id(socialNetwork.getId())
                           * .url(socialNetwork.getUrl()) .user(User.builder()
                           * .id(socialNetwork.getUser().getId())
                           * .email(socialNetwork.getUser().getEmail()) .build())
                           ...
                           * .hostPath(socialNetwork.getSocialNetworkImage().getHostPath()) .build())
                           ...
                           * .password(expected.getOwnSecurity().getPassword()) .user(User.builder()
                           * .id(expected.getOwnSecurity().getUser().getId())
                           * .email(expected.getOwnSecurity().getUser().getEmail()) .build()) .build() :
                           * null) .lastActivityTime(expected.getLastActivityTime())
                           * .userAchievements(expected.getUserAchievements() != null ?
                           * expected.getUserAchievements() .stream().map(userAchievement ->
                           * UserAchievement.builder() .id(userAchievement.getId()) .user(User.builder()
                           * .id(userAchievement.getUser().getId()) .build())
                           * .achievement(Achievement.builder()
                           * .id(userAchievement.getAchievement().getId()) .build()) .build())
                           * .collect(Collectors.toList()) : new ArrayList<>())
                           * .userActions(expected.getUserActions() != null ? expected.getUserActions()
                           * .stream().map(userAction -> UserAction.builder() .id(userAction.getId())
                           * .achievementCategory(AchievementCategory.builder()
                           * .id(userAction.getAchievementCategory().getId()) .build())
                           * .count(userAction.getCount()) .user(User.builder()
                           * .id(userAction.getUser().getId()) .build()) .build())
                           * .collect(Collectors.toList()) : new ArrayList<>())
