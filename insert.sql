...
INSERT INTO eco_news(title, creation_date, text, image_path)
VALUES ('Лекція про сортування сміття', '2019-11-14 14:10:16.769000', 'Опис лекції про сміття', 'шлях до картинки'),
       ('Майстер-клас по приготу-ванню вегетаріанської лазаньї від шефа', '2019-11-22 11:10:16.769000', 'опис майстер класу', 'шлях до картинки'),
       ('Розважальний захід для малих еко-активістів', '2019-11-22 11:10:16.769000', 'опис заходу', 'шлях до картинки');
