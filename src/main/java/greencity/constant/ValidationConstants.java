...
public class ValidationConstants {
    ...
    public static final String DISCOUNT_VALUE_MIN_ERROR = "Min discount value is 0";
    public static final String DISCOUNT_VALUE_MAX_ERROR = "Max discount value is 100";
