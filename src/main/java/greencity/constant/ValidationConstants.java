...
public class ValidationConstants {
    ...
    public static final String INVALID_FIRSTNAME_LENGTH =
            "The firstName field should be between 2 and 20 characters";
    ...
    public static final String INVALID_LASTNAME_LENGTH =
            "The lastName field should be between 2 and 20 characters";
    ...
    public static final int PLACE_ADDRESS_MAX_LENGTH = 30;
