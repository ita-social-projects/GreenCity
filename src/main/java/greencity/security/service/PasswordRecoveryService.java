 ...
 * but do neither updates the password directly, nor sends a recovery email. These
...
public interface PasswordRecoveryService {
     ...
     * @param newPassword new password to which current user's password will be replaced
     */
