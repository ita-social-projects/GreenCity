...
public class TipsAndTricksCommentControllerTest {
    ...
    public void saveTest() throws Exception {
        ...
        verify(tipsAndTricksCommentService)
                .save(eq(1L), eq(addTipsAndTricksCommentDtoRequest), eq(new User()));
    }
    ...
    public void findAllTest() throws Exception {
        ...
        verify(userService).findByEmail(eq("Liam.Johnson@gmail.com"));
        verify(tipsAndTricksCommentService).findAllComments(eq(pageable), eq(new User()), eq(1L));
    }
    ...
    public void deleteTest() throws Exception {
        ...
        verify(userService).findByEmail(eq("Liam.Johnson@gmail.com"));
        verify(tipsAndTricksCommentService).deleteById(eq(1L), eq(new User()));
    }
    ...
    public void updateTest() throws Exception {
        ...
        verify(userService).findByEmail(eq("Liam.Johnson@gmail.com"));
        verify(tipsAndTricksCommentService)
                .update(eq("text"), eq(1L), eq(new User()));
    }
