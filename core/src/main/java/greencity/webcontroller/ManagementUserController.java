...
public class ManagementUserController {
    ...
    /**
     * Method for setting {@link User}'s status to DEACTIVATED, so the user will not
    ...
    /**
     * Method for setting to a list of {@link User} status DEACTIVATED, so the users
     * will not be able to log in into the system.
     *
