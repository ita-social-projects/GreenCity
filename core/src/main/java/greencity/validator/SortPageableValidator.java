 ...
 * <li>If the class is annotated with {@link Sortable} but the {@code fields()}
 * list is empty, the validator will check for {@link Sortable} annotations on
 * individual fields and use them.</li>
 * <li>If neither the class nor its fields define explicit sortable fields, all
 * declared fields of the class will be allowed for sorting.</li>
 * </ul>
 * <p>
...
public class SortPageableValidator {
    /**
     * Cache of sortable fields for each class, computed once and reused. The key is
     * the target class; the value is the set of field names permitted for sorting.
     */
    ...
    /**
     * Validates that all sort properties specified in the given {@link Sort} object
     * are allowed for the specified class.
     * <p>
     ...
     * @throws UnsupportedSortException if any sort property is not in the allowed
     *                                  set of sortable fields
     */
