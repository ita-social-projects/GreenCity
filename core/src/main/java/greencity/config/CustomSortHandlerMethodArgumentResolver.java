...
/**
 * Custom implementation of {@link SortArgumentResolver} that parses and validates
 * {@code sort} query parameters from HTTP requests.
 * <p>
 * This resolver:
 * </p>
 * <ul>
...
public class CustomSortHandlerMethodArgumentResolver implements SortArgumentResolver {
     ...
     * <p>
     * This validator is invoked when a controller method is annotated with {@link ApiPageable},
     * checking that the {@link Sort} object only contains properties declared as sortable.
     * </p>
     */
     ...
     * @return {@code true} if the parameter type is {@link Sort}, {@code false} otherwise
     */
    @Override
    ...
    /**
     * Resolves the {@link Sort} argument for a controller method by parsing
     * the "sort" query parameters from the HTTP request.
     * <p>
     * If the controller method is annotated with {@link ApiPageable}, the
     * resolved {@link Sort} object is validated using {@link SortPageableValidator}.
     * </p>
     *
     ...
     * @param binderFactory a factory for creating WebDataBinders, may be {@code null}
     * @return a {@link Sort} instance containing the parsed sorting orders
     * @throws IllegalArgumentException if any sort parameter is invalid or incorrectly formatted
     */
    @NonNull
    @Override
    ...
    /**
     * Parses the "sort" query parameters from the HTTP request and converts them into a {@link Sort} object.
     * <p>
     * Each parameter should be in the format {@code property,(asc|desc)}. If the direction is omitted,
     * ascending order is assumed. Multiple sort parameters can be provided by repeating the query parameter.
     * </p>
     *
     * @param webRequest the current web request
     * @return a {@link Sort} object containing the parsed sort orders, or {@link PageableConstants#DEFAULT_SORT} if none are provided
     * @throws IllegalArgumentException if a sort parameter is invalid or contains more than one comma
     */
