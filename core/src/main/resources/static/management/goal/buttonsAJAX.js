...
$(document).ready(function () {
    ...
    $('#btnSearchImage').click(function (){
        let url = "/management/goals?query=";
    ...
    $('#deleteAllSubmit').on('click', function (event) {
        ...
        var href = '/management/goals/deleteAll';
        $.ajax({
            url: href,
            type: 'delete',
            dataType: 'json',
    ...
    $('#submitAddBtn').on('click', function (event) {
        event.preventDefault();
        clearAllErrorsSpan();
        var formData = $('#addGoalForm').serializeArray().reduce(function (obj, item) {
    ...
    $('#submitEditBtn').on('click', function (event) {
        event.preventDefault();
        clearAllErrorsSpan();
        var formData = $('#editGoalForm').serializeArray().reduce(function (obj, item) {
            obj[item.name] = item.value;
            return obj;
        }, {});
        var returnData = {
        ...
        var href = '/management/goals/' + returnData.id;
