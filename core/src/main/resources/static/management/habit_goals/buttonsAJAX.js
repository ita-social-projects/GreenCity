...
$(document).ready(function () {
    ...
    $('#deleteAllSubmit').on('click', function (event) {
        ...
        var href = '/management/habit-shoping-list/deleteAll/?habitId='+habitId;
        $.ajax({
            url: href,
            type: 'delete',
            dataType: 'json',
    ...
    $('#addAllSubmit').on('click', function (event) {
        ...
        var href = '/management/habit-shoping-list/addAll/?habitId='+habitId;
        $.ajax({
            url: href,
            type: 'post',
            dataType: 'json',
...
//delete button in deleteGoalModal
