...
/**
 * An abstract class that is used to store a vector of tags for some entity with {@link Tag}s.
 *
...
public abstract class EntityWithTagsVector {
    ...
    /**
     * The vector is built from the given collection of tags and the given mapping of tag ids to their indexes
     * in the vector.
     * The vector is initialized with all elements set to 0.0f and then tags from the given collection are set
     * to 1.0f in the vector.
     *
