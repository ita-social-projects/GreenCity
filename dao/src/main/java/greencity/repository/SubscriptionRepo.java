...
public interface SubscriptionRepo extends JpaRepository<Subscription, Long> {
     ...
     * @return {@code true} if a subscription with the given token exists, otherwise {@code false}.
     */
     ...
     * @return {@code true} if a subscription with the given email and type exists, otherwise {@code false}.
     */
     ...
     *
     * @param unsubscribeToken the unique token used to identify the subscription to be deleted.
     */
