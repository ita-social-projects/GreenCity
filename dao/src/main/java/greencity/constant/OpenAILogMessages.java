...
public class OpenAILogMessages {
    public static final String OPENAI_REQUEST_INITIATED = "Making request to OpenAI with {} language and prompt: {}";
    ...
    public static final String EXECUTION_TIME_FOR_METHOD = "Execution time for 'makeRequest': {} ms for {} language and prompt: \"{}\"";
