...
class AddUpdateCustomHabitDtoResponseTest {
    ...
    void validComplexityInAddCustomHabitDtoResponseTest(Integer complexity) {
        ...
        Set<ConstraintViolation<AddUpdateCustomHabitDtoResponse>> constraintViolations =
