 ...
 *
 * <p>Each language is defined with the following attributes:</p>
 * <ul>
 *   <li><b>code</b>: The language code (e.g., "en" for English, "ua" for Ukrainian).</li>
 *   <li><b>displayName</b>: The human-readable name of the language.</li>
 *   <li><b>formattedDisplayName</b>: A formatted version of the display name.</li>
 * </ul>
 *
 * <p>The enum also provides a utility method to resolve a language from its code.</p>
 */
@Getter
