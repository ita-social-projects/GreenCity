...
public class ErrorMessage {
    ...
    public static final String ECO_NEWS_NOT_FOUND_BY_ID = "Eco new doesn't exist by this id: ";
    ...
    public static final String ECO_NEWS_NOT_IN_FAVORITES = "This eco new is not in favorites.";
