...
public class GrammarCheckConstants {
    ...
    public static final String ERROR_GRAMMAR_CHECKING_MESSAGE =
        "An error occurred while checking the grammar of the provided text.";
    ...
    public static final String GRAMMAR_CHECK_COMPLETED_LOG =
        "🏁 Grammar check completed. Corrected text length: {} characters";
    public static final String FINAL_CORRECTED_TEXT_LOG = "Final corrected text: \"{}\"";
    public static final String GRAMMAR_CHECK_ERROR_LOG =
        "❌ Error occurred during grammar check for text: \"{}\". Exception: {}";
    public static final String METHOD_EXECUTION_DURATION_LOG = "Method 'checkGrammar' executed in {} ms.";
    public static final String CLEAR_CACHE_LOG_MESSAGE =
        "🗑️ Method 'clearCache' called to clear cache for text: \"{}\" at {}";
