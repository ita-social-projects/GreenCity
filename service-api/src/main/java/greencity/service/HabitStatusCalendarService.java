...
public interface HabitStatusCalendarService {
    ...
    /**
     * Method to return all enrolled {@code HabitStatusVO} dates after {@link LocalDateTime} dateTime.
     *
    ...
    /**
     * Method return all enrolled {@code HabitStatusVO} dates before {@link LocalDateTime} dateTime.
     *
