...
public interface UserNotificationService {
    ...
    /**
     * Method to get all notifications for the current user by the search request
     * sorted by the date in the descending order. If a specific project name is
     * provided, only notifications for that project are returned. If
     ...
     * @param searchRequest is a search request that the user enters into the search
     *                      field
